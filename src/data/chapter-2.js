  ...
  scenes: {
    ...
    scene_conflict: {
      ...
      choices: [
        ...
        { text: '"两位——一家一家说。谁先来的？"', next: 'scene_triage', attr: { 满意度: 4 } },
        { text: '"护士——把分诊记录给我。"不站队。先看客观数据。', next: 'scene_triage', attr: { 专业度: 6 } },
        { text: '先走到年轻女人跟前。"你现在最不舒服的是什么？"——她在呻吟。直觉告诉你先确认她。', next: 'scene_young_woman_first', attr: { 满意度: 3 } },
      ],
    },
    ...
    scene_triage: {
      ...
      choices: [
        ...
        { text: '站在中间。"两位——各自说一下怎么不舒服。老人家先说。"', next: 'scene_old_man', attr: { 满意度: 3 } },
      ],
    },
    ...
    scene_old_man_chest: {
      ...
      choices: [
        { text: '"叔叔——你这个不像是胃的问题。我需要给你做个心电图——看看心脏。"', next: 'scene_old_man_ecg', attr: { 专业度: 8, 满意度: 3 } },
    ...
    scene_old_man_compare: {
      ...
      choices: [
        { text: '"叔叔——这个不一样很重要。我需要给你做个心电图——查查心脏。"', next: 'scene_old_man_ecg', attr: { 专业度: 8, 满意度: 3 } },
    ...
    scene_old_man_gastric: {
      ...
      choices: [
        { text: '"吃了胃药没用——这个很重要。我需要给你做个心电图——排除一下心脏的问题。"', next: 'scene_old_man_ecg', attr: { 专业度: 8, 满意度: 3 } },
    ...
    scene_old_man_ecg: {
      ...
      choices: [
        { text: '"阿姨——他这个年纪、这个症状——心脏问题有时候不按典型方式表现。胃不舒服——不一定是胃。"', next: 'scene_old_man_ecg_done', attr: { 专业度: 5, 满意度: 4 } },
        { text: '"先查心电图——排除了心脏问题大家都放心。"', next: 'scene_old_man_ecg_done', attr: { 专业度: 4 } },
        { text: '什么都不解释。直接开单。', next: 'scene_old_man_ecg_done', attr: { 满意度: -1 } },
    ...
    scene_young_woman: {
      ...
      choices: [
        { text: '"你的症状更符合偏头痛。但急性剧烈头痛——建议做CT排除一下。你觉得呢？"', next: 'scene_young_woman_ct', attr: { 专业度: 5, 满意度: 3 } },
    ...
    scene_results_explain: {
      ...
      choices: [
        { text: '"让分诊先看。我歇五分钟。"你靠在椅背上——眼睛闭上了。', next: 'scene_rest_choice', attr: { 体力: 8, 满意度: -3 } },
        { text: '"好。让他进来吧。"你站起来。腿在抖。', next: 'scene_debrief', attr: { 体力: -3, 满意度: 3 } },
        { text: '"小林——能不能让值班的二线先接？我真的需要缓一下。"', next: 'scene_debrief', attr: { 体力: 5, 满意度: 1 } },
      ],
    },
    ...
    scene_rest_choice: {
      ...
      choices: [
        ...
        { text: '"再给我两分钟。"闭上眼。小林叹了口气出去了。', next: 'scene_debrief', attr: { 体力: 5, 满意度: -5 } },
      ],
    },
